    ...
    <header class="navbar px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex-none">
        <ul class="flex flex-column px-1 space-x-2 items-center">
          <li>
            <.link navigate="/leads" class="btn btn-ghost btn-sm gap-1.5">
              <svg
          ...
          <li>
            <.link navigate="/drafts" class="btn btn-ghost btn-sm gap-1.5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="size-4"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path d="M3 4a2 2 0 0 0-2 2v1.161l8.441 4.221a1.25 1.25 0 0 0 1.118 0L19 7.16V6a2 2 0 0 0-2-2H3Z" />
